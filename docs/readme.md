...
1. **LLM Research Agent** (Gemini + Claude) — Validación adversarial de tendencias del mercado de IA mediante web search
...
│  │     AGENT        │    │                  │    │     ENGINE           │  │
│  │                  │    │                  │    │                      │  │
│  │  Gemini + Claude │───▶│  Excel/CSV       │───▶│  PuLP Knapsack       │  │
│  │  (Adversarial)   │    │  12-column       │    │  + Topological       │  │
│  │                  │    │  schema          │    │  Sort                │  │
│  │  AI Trend        │    │                  │    │                      │  │
│  │  Scanner v3.1    │    │  data_loader.py  │    │  engine.py           │  │
│  └──────────────────┘    └──────────────────┘    └──────────────────────┘  │
│           │                       │                        │                │
│           │                       │                        │                │
│           ▼                       ▼                        ▼                │
...
flowchart LR
    subgraph INPUT["📥 INPUT"]
        A[AI Trend Scanner<br/>Prompt v3.1] -->|Web Search| B[Gemini + Claude<br/>Adversarial]
...
Usa el prompt `AI_TREND_SCANNER_v3.1.txt` con validación adversarial entre Gemini y Claude para generar/actualizar tu roadmap.
...
├── prompts/
│   ├── AI_TREND_SCANNER_v3.1.txt    # Prompt principal
│   └── ADVERSARIAL_REVIEW.txt       # Prompt de auditoría
├── docs/
...
- **Anthropic Claude + Google Gemini** — Validación adversarial de tendencias

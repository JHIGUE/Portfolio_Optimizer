...
with tabs[4]: # AUDITORÍA
    # AÑADIDO: 'Empleabilidad', 'Capa_score', 'Facilidad' para ver el origen del cálculo
    audit_cols = ['ID', 'Actividad', 'Score', 'Score_Real', 'Probabilidad', 'Empleabilidad', 'Capa_score', 'Facilidad', 'Eficiencia']
